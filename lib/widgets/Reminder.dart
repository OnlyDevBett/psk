...
class Reminder {
  static void showReminder(BuildContext context, List<String> inputdata,
      EventsModel myEventsModel) async {
    showDialog(
        context: context,
        builder: (context) {
          return StatefulBuilder(builder: (context, setState) {
            ...
            return GestureDetector(
              ...
              child: AlertDialog(
                ...
                title: Text(
                  'Reminder For, ' +
                      DateSupport.getTime(inputdata[2], inputdata[3]) +
                      ' ' +
                      DateSupport.getDay(inputdata[2]) +
                      ' ' +
                      DateSupport.getDate(inputdata[2]),
                  style: TextStyle(
                    fontSize: 22,
                      ...
                      : Column(
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                FlatButton(
                                  child: Text('Leave a Notification',
                                      style: TextStyle(
                                        color: Colors.blue[200],
                                      )),
                                  padding: EdgeInsets.all(1),
