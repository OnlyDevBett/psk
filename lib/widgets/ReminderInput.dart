        ...
        return StatefulBuilder(
          builder: (context,setState){
            return AlertDialog(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Spacer(),
                          FlatButton(child: Text(isTimeset ? 'Change time' : '   Set time',style: TextStyle(color: Colors.green),textAlign: TextAlign.right,),
                            padding: EdgeInsets.all(0),
                            onPressed: (){
              ...
              actions: <Widget>[
                FlatButton(child: Text('Add Reminder',style: TextStyle(color: Colors.green,)),
                  onPressed: (){
                ...
                FlatButton(onPressed: (){Navigator.pop(context);}, child: Text('Back',style: TextStyle(color: Colors.green,))),
              ],
            );
          }
        );
