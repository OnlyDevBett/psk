...
import 'family_law_upload.dart';

class FamilyLaw extends StatefulWidget {
  @override
  _FamilyLawState createState() => _FamilyLawState();
}

class _FamilyLawState extends State<FamilyLaw> {
  bool isAdmin = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: new AppBar(
          ...
          title: Text('Family Law and Succession'),
          centerTitle: true,
          actions: <Widget>[
        ...
        floatingActionButton: Visibility(
          ...
          child: FloatingActionButton(
            ...
            onPressed: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) =>  FamilyLawUpload()));
            },
          ),
        ),
        body: FutureBuilder(
                      ...
                      child: GestureDetector(
                        ...
                        onTap: () async {
                          ...
                          setState(() {
                            ...
                            fileUrl =
                            "https://pasune.or.ke/Mobile_App_DB/family_law/${list[index]['fileName']}";
                          });
                          print(fileUrl);
                          Navigator.push(
                            context,
  ...
  Future<List> getFiles() async {
    var url = 'https://pasune.or.ke/Mobile_App_DB/family_law.php';
  ...
  Future _deleteFile(String fileName) async{
    var url =
        'https://pasune.or.ke/Mobile_App_DB/delete_family_law.php';
