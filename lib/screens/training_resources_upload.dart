...
class TrainingResourcesUpload extends StatefulWidget {
  @override
  _TrainingResourcesUploadState createState() => _TrainingResourcesUploadState();
}

class _TrainingResourcesUploadState extends State<TrainingResourcesUpload> {
  ...
  uploadFile() async {
    String uploadurl = "https://pasune.or.ke/Mobile_App_DB/training_resources_upload.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title:Text("Choose File and Upload"),
        ), //set appbar
        body:Container(
