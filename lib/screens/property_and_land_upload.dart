...
class PropertyAndLandUpload extends StatefulWidget {
  @override
  _PropertyAndLandUploadState createState() => _PropertyAndLandUploadState();
}

class _PropertyAndLandUploadState extends State<PropertyAndLandUpload> {
  ...
  uploadFile() async {
    String uploadurl = "https://pasune.or.ke/Mobile_App_DB/property_land_upload.php";
