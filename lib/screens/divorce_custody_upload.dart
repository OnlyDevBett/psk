...
class DivorceCustodyUpload extends StatefulWidget {
  @override
  _DivorceCustodyUploadState createState() => _DivorceCustodyUploadState();
}

class _DivorceCustodyUploadState extends State<DivorceCustodyUpload> {
  ...
  uploadFile() async {
    String uploadurl = "https://pasune.or.ke/Mobile_App_DB/divorce_custody_upload.php";
