...
import 'property_and_land_upload.dart';

class PropertyAndLaw extends StatefulWidget {
  @override
  _PropertyAndLawState createState() => _PropertyAndLawState();
}

class _PropertyAndLawState extends State<PropertyAndLaw> {
  bool isAdmin = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: new AppBar(
          ...
          title: Text('Property and Land Law'),
          centerTitle: true,
          actions: <Widget>[
        ...
        floatingActionButton: Visibility(
          ...
          child: FloatingActionButton(
            ...
            onPressed: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) =>  PropertyAndLandUpload()));
            },
          ),
        ),
        body: FutureBuilder(
                          ...
                          trailing: IconButton(
                              ...
                              onPressed: () {
                                ...
                                setState(() {
                                  ...
                                  fileUrl =
                                  "https://pasune.or.ke/Mobile_App_DB/property_land/${list[index]['fileName']}";
                                });
                                // _download();
                              }),
                        ),
  ...
  Future<List> getFiles() async {
    var url = 'https://pasune.or.ke/Mobile_App_DB/property_land.php';
  ...
  Future _deleteFile(String fileName) async{
    var url =
        'https://pasune.or.ke/Mobile_App_DB/delete_property_land.php';
