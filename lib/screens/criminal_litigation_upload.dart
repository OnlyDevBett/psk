...
class CriminalLitigationUpload extends StatefulWidget {
  @override
  _CriminalLitigationUploadState createState() => _CriminalLitigationUploadState();
}

class _CriminalLitigationUploadState extends State<CriminalLitigationUpload> {
  ...
  uploadFile() async {
    String uploadurl = "https://pasune.or.ke/Mobile_App_DB/criminal_litigation_upload.php";
