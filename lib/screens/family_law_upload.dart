...
class FamilyLawUpload extends StatefulWidget {
  @override
  _FamilyLawUploadState createState() => _FamilyLawUploadState();
}

class _FamilyLawUploadState extends State<FamilyLawUpload> {
  ...
  uploadFile() async {
    String uploadurl = "https://pasune.or.ke/Mobile_App_DB/family_law_upload.php";
