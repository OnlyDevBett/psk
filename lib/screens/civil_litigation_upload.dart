...
class CivilLitigationUpload extends StatefulWidget {
  @override
  _CivilLitigationUploadState createState() => _CivilLitigationUploadState();
}

class _CivilLitigationUploadState extends State<CivilLitigationUpload> {
  ...
  uploadFile() async {
    String uploadurl = "https://pasune.or.ke/Mobile_App_DB/civil_litigation_upload.php";
